                ...
                <header className="bg-white shadow-md">
                    ...
                    {isMobileMenuOpen && (
                        <div className="md:hidden bg-white shadow-md p-4">
                            <Link href="/articles" onClick={toggleMobileMenu} className="block py-2 text-gray-600 hover:text-gray-900 relative after:absolute after:left-0 after:bottom-[-2px] after:w-full after:h-[2px] after:bg-black after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100"><span>Articles</span></Link>
                            <Link href="/blurbs" onClick={toggleMobileMenu} className="block py-2 text-gray-600 hover:text-gray-900 relative after:absolute after:left-0 after:bottom-[-2px] after:w-full after:h-[2px] after:bg-black after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100"><span>Blurbs</span></Link>
                            <Link href="/oidp" onClick={toggleMobileMenu} className="block py-2 text-gray-600 hover:text-gray-900 relative after:absolute after:left-0 after:bottom-[-2px] after:w-full after:h-[2px] after:bg-black after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100"><span>OIDP Book</span></Link>
                            <Link href="/contact" onClick={toggleMobileMenu} className="block py-2 text-gray-600 hover:text-gray-900 relative after:absolute after:left-0 after:bottom-[-2px] after:w-full after:h-[2px] after:bg-black after:scale-x-0 after:origin-left after:transition-transform after:duration-200 hover:after:scale-x-100"><span>Contact</span></Link>
                        </div>
                    )}
                </header>
            </div>
