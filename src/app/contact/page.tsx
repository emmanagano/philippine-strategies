    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f9f9f9] py-10 px-4">
      <div className="max-w-2xl w-full text-center mb-10">
        ...
        <p className="mt-4 text-gray-600">
          ...
          signed copy of{" "}
          <span className="italic">OIDP - Onli In Da Pilipines</span>, send us a
          message below.
        </p>
      </div>
      ...
      <div className="relative bg-gradient-to-br from-[#001F3F] via-[#C92F2F] to-[#FFD700] p-1 rounded-xl shadow-lg max-w-xl w-full">
        ...
        <form
          ref={form}
          onSubmit={sendEmail}
          className="relative z-10 bg-white p-8 rounded-xl space-y-6 shadow-md"
        >
          <div>
            ...
            <input
              ...
              name="name"
              required
              className="mt-1 w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-indigo-500 text-gray-900 placeholder:text-gray-500"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
          ...
          <button
            type="submit"
            className="w-full bg-[#C92F2F] hover:bg-[#a62626] text-white font-semibold py-2 rounded-md transition"
          >
            Send Message
          </button>
