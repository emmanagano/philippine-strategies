      ...
      <section className="max-w-4xl mx-auto">
        ...
        <article className="prose prose-lg max-w-none text-gray-900 bg-white p-6 md:p-8 rounded-md shadow-md">
          <blockquote className="italic text-lg font-semibold border-l-4 pl-4 border-gray-400 mb-8 bg-gray-100 p-4 rounded-md">
            “In fact, no one from the US knows this country better than the
            Wagner family; they all served here in the military”
            <br />
            <span className="text-sm font-normal block mt-1">
              – Former President Fidel V. Ramos, as quoted in an aside meeting
              during the 2012 ASEAN Summit.
            </span>
          </blockquote>
          ...
          <p className="mt-6">
            ...
            the first family member, Capt. John A., arrived in January of 1899.
          </p>
          ...
          <div className="mt-6 overflow-auto whitespace-nowrap text-sm">
            <p>
              ...
              (from bottom of page 57, “Captain John A. Wagner, 31st US Army
              Infantry Regiment”).
            </p>
          </div>
          ...
          <p className="mt-6">
            ...
            Army, Navy and Marines. After separation or retirement, many settled
            here with Filipina wives and their children, starting local
            businesses or working for the US government in a variety of
          ...
          <p className="mt-6">
            ...
            Filipino brothers and sisters, whom they had known and grew up with
            since early childhood. These Americans, speaking fluent,
            ...
            or Aeta genetics. During the post-war decades, natural attrition and
            migration back to mainland America saw their numbers dwindle to
            under half the pre-war number, replenished only by military retirees
            from Subic Naval and Clark Air Force bases.
          </p>
          ...
          <p className="mt-6">
            ...
            most part engaged in charitable or philanthropic efforts to aid the
            peoples of the Philippines, they also provided and continue to
            effect services for American industry, US government and visiting
            military elements using their extensive familial contacts with local
            power centers garnered and developed over more than a century of
            relationships.
          </p>
          ...
          <p className="mt-6">
            ...
            of ambassadors, consuls or State Department officials who, living in
            the embassy bubble, will insist they came to understand the country
            and its peoples after only a typical 3-year posting, ignoring wisdom
            and advice from the “Puting Maalam” (Old-timers / Wisemen) at their
            peril and frequent disgrace.
          </p>
          ...
          <p className="mt-6">
            ...
            up being scandal-ridden preserves of illegal Chinese online gambling
            and Korean money-laundering.
          </p>

          <p className="mt-6">
            The US military, emboldened by the Benigno “Noynoy” Aquino III
            administration that enacted the Enhanced Defense Cooperation
            Agreement (EDCA) in 2014, was stymied just two years later when the
            xenophobic, pro-China Rodrigo Duterte ascended to the presidency.
          </p>
          ...
          <p className="mt-6">
            ...
            who listened to the Puting Maalam were able to enjoy success during
            this period.
          </p>
